...
app.locals.siteName = "Task Buddy";
app.use(bodyParser.urlencoded({ extended: false }));

app.use(cookieParser());
app.use("/users", userRoute);
app.use("/tasks", auth.authenticateUser, taskRoute);
...
app.get("/create_task", auth.authenticateUser, (req, res) => {
